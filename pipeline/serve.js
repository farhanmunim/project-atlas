...
const HIST_EP = {
  ...
  "accidents":           { table: "accidents", filters: { from: ["collision_date", "gte"], to: ["collision_date", "lte"], severity: ["severity", "eq"], borough: ["borough", "eq"], road_type: ["road_type", "eq"], speed_limit: ["speed_limit", "eq"] }, defaultOrder: "collision_date.desc", desc: "STATS19 bus collisions over time — filter by from/to date, severity, borough, road_type, speed_limit; rows also carry junction/light/weather/road_surface." },
};
