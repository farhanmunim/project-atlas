...
| `GET /api/v1/accidents` | STATS19 bus collisions — lat/lng, severity, date, borough, vehicles, plus decoded context: `roadType`, `speedLimit`, `junction`, `light`, `weather`, `roadSurface`, `day`, `timeBand` |
